...
using v1 = IATITester.IATILib.IATIVersion1;
using v2 = IATITester.IATILib.IATIVersion2;
...
namespace IATITester.IATILib.IATIVersion2
{
    ...
    public class ConvertIATIVersion2 : IConverterIATI
    {
        /// <summary>
        /// Default Constructor
        /// </summary>
        public ConvertIATIVersion2()
        {
        }
        ...
        public IXMLResult ConvertIATIXML(IXMLResult obj)
        {
            ...
            xmlResult = (XMLResultVersion2)obj;
